# demo_custom_made_environment.py
"""
Run a training and testing pipeline with a custom-made environment, i.e. gym's fetch. 
https://github.com/hermanjakobsen/robotic-ultrasound-imaging/blob/master/src/rl.py
"""
import gym
import os
import yaml
...
#from my_models.grippers import UltrasoundProbeGripper #TODO replace with standard robosuite gripper registration for panda
...
if __name__== '__main__':
    register_env(FetchPickAndPlaceEnv)
