...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def reset(self):
        ...
        print("show obeservations")
        print(self._get_obs(force_update=True)['observation'])
        print("grip pos is")
        print(self._get_obs(force_update=True)['observation'][:3])
        print("grip quat is")
        print(self._get_obs(force_update=True)['observation'][3:7])
        print("grip velp is")
        print(self._get_obs(force_update=True)['observation'][7:10])
        print("grip velr is")
        print(self._get_obs(force_update=True)['observation'][10:13])
        print("finger state is")
        print(self._get_obs(force_update=True)['observation'][13:15])
        print("finger vel is")
        print(self._get_obs(force_update=True)['observation'][15:17])
        print("obj pos is")
        print(self._get_obs(force_update=True)['observation'][17:20])
        print("obj quat is")
        print(self._get_obs(force_update=True)['observation'][20:24])
        print("obj velp is")
        print(self._get_obs(force_update=True)['observation'][24:27])
        print("obj velr is")
        print(self._get_obs(force_update=True)['observation'][27:30])
        print("obj rel pos is")
        print(self._get_obs(force_update=True)['observation'][30:33])
        print("obj rel rot is")
        print(self._get_obs(force_update=True)['observation'][33:37])
