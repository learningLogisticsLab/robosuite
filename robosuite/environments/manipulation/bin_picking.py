...
class BinPicking(SingleArmEnv):
    ...
    def __init__(
        ...
        self.obj_names = ["Milk", "Bread", "Cereal", "Can"] #[item.upper() for item in self.object_to_id.keys()]
    ...
    def _load_model(self):
        ...
        self.bin_size = mujoco_arena.table_full_size # why bin set to table
